...
export const dialogueData = {
    pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
        ...
        Here is my <a href="https://github.com/Almesaody" target="_blank">Github</a>!`,
    ...
    I also make game programming tutorials on YouTube. Go sub to <a href="https://youtube.com/@Almesaody" target="_blank">my channel</a>! (If you like the content)
    ...
    tv: `That's my TV. I've been watching tech youtubers a lot recently like :
     <a href="https://www.youtube.com/@Almesaody" target="_blank">Theprimeagen</a>, <a href="https://www.youtube.com/@Almesaody" target="_blank">Theo - t3.gg</a>,
    <a href="https://www.youtube.com/@Almesaody" target="_blank">PirateSoftware</a> (sometimes) and <a href="https://www.youtube.com/@Almesaody" target="_blank">Melkey</a>!`,
    ...
    resume: `This is my desk and on it is my resume. <a href="https://github.com/Almesaody/Resume/blob/main/JSLegend%20Resume-1.pdf" target="_blank">Check it out?</a>
    ...
    Kaboom.js by watching some of my tutorials <a href="https://youtube.com/@Almesaody" target="_blank">here</a>.`,
